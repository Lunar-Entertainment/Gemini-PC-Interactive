...
class Settings:
    ...
    ACTION_DELAY_SEC: float = float(os.getenv("ACTION_DELAY_SEC", "0.15"))
    ...
    # Internal GenAI transport credentials (used automatically with Google One auth)
    INTERNAL_TRANSPORT_KEY: str = os.getenv("GEMINI_API_KEY", "REDACTED_GEMINI_API_KEY_00000000000000000000000000000").strip().strip('"').strip("'")
